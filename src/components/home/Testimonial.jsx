...
const Testimonial = () => {
  return (
    <>
      ...
      <div className="flex flex-wrap items-center justify-center gap-6 pt-14 pb-5 mt-10">
        <div className="text-sm w-80 border border-gray-200 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 mb-15 md:mb-0">
